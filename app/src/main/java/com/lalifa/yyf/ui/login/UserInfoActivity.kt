...
import com.lalifa.yyf.api.ImgBean
import com.lalifa.yyf.api.register
import com.lalifa.yyf.api.upload
import com.lalifa.yyf.databinding.ActivityUserInfoBinding
import java.util.*
...
class UserInfoActivity : BaseActivity<ActivityUserInfoBinding>() {
    ...
    private fun register(nickName: String) {
        scopeNetLife { // 创建作用域
            ...
            SensorsUtil.instance().register("app模块", "注册", "注册页")
