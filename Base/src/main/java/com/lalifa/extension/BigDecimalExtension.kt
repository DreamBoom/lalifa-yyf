 ...
 * @see RoundingMode
 */
fun Number.replace(scale: Int = 0, mode: Int = BigDecimal.ROUND_HALF_UP): String =
    this.toString().replace(scale, mode)
...
fun Double?.to6(): String {
    if (null == this || this < 1) return "0"
