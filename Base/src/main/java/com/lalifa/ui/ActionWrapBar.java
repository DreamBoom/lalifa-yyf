...
import com.lalifa.ui.interfaces.IWrapBar;
...
public class ActionWrapBar implements IWrapBar<ActionWrapBar> {
    ...
    public ActionWrapBar(AppCompatActivity activity) {
        ...
        tvTitle.setTextColor(ResUtil.getColor(R.color.white));
    ...
    public boolean onCreateOptionsMenu(@NonNull Menu menu) {
        ...
        LogCat.e("ActionBarWapper", "action len = " + len);
        return len > 0;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (null != onMenuSelectedListener) {
            ...
            if (null != title) {
                ...
                LogCat.e("ActionBarWapper", "text = " + text);
                int index = -1;
                ...
                LogCat.e("ActionBarWapper", "MenuItem title is null !");
            }
