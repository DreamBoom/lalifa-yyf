...
import com.lalifa.utils.BroadcastUtil;
...
public class UIStack {
    ...
    public synchronized void add(IBasis iBasis) {
        ...
        LogCat.e(TAG, "add : size = " + ibasiss.size() + " ibase:" + iBasis.getClass().getSimpleName());
    }
    ...
    public synchronized void remove(IBasis remove) {
        ...
        LogCat.e(TAG, "remove : size = " + ibasiss.size() + " ibase:" + remove.getClass().getSimpleName());
