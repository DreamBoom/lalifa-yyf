...
public final class ActivityManager implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityStarted(@NonNull Activity activity) {
        LogCat.i("%s - onStart", activity.getClass().getSimpleName());
    }

    @Override
    public void onActivityResumed(@NonNull Activity activity) {
        LogCat.i("%s - onResume", activity.getClass().getSimpleName());
        if (mTopActivity == activity && mResumedActivity == null) {
            for (ApplicationLifecycleCallback callback : mLifecycleCallbacks) {
                callback.onApplicationForeground(activity);
            }
            LogCat.i("%s - onApplicationForeground", activity.getClass().getSimpleName());
        }
        mTopActivity = activity;
    ...
    public void onActivityPaused(@NonNull Activity activity) {
        LogCat.i("%s - onPause", activity.getClass().getSimpleName());
    }

    @Override
    public void onActivityStopped(@NonNull Activity activity) {
        LogCat.i("%s - onStop", activity.getClass().getSimpleName());
        ...
        if (mResumedActivity == null) {
            ...
            LogCat.i("%s - onApplicationBackground", activity.getClass().getSimpleName());
        }
    }

    @Override
    public void onActivitySaveInstanceState(@NonNull Activity activity, @NonNull Bundle outState) {
        LogCat.i("%s - onSaveInstanceState", activity.getClass().getSimpleName());
    }

    @Override
    public void onActivityDestroyed(@NonNull Activity activity) {
        LogCat.i("%s - onDestroy", activity.getClass().getSimpleName());
        ...
        if (mActivitySet.size() == 0) {
            ...
            LogCat.i("%s - onApplicationDestroy", activity.getClass().getSimpleName());
        }
    }
