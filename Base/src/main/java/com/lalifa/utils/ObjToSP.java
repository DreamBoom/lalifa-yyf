...
public class ObjToSP<T> {
    ...
    private void saveJson(String jsonK, String jsonV) {
        SPUtil.set(spFileName, jsonK, jsonV);
    }

    private String getJson(String jsonK) {
        return SPUtil.get(spFileName, jsonK, "");
    }

    private String deleteJson(String jsonK) {
        String deleteJson = SPUtil.get(spFileName, jsonK, "");
        SPUtil.remove(spFileName, jsonK);
        return deleteJson;
    }
    ...
    protected final List<T> getAllEntity() {
        ...
        Map<String, String> allMap = (Map<String, String>) SPUtil.getAll(spFileName);
        if (null != allMap) {
