...
import com.lalifa.widget.dialog.dialog.DialogBuilder;
import com.lalifa.widget.dialog.dialog.IBuilder;
import com.lalifa.widget.dialog.dialog.IDialog;
...
public class FeedbackHelper implements IFeedback {
    ...
    public void statistics() {
        int last = SPUtil.get(KEY_TIME, 0);
        SPUtil.set(KEY_TIME, last + 1);
        if (enableScore() && null != feedbackListener) {
            feedbackListener.onFeedback();
        }
    }
...
//                SharedPreferUtil.get(KEY_TIME, 0) >= LIMT;
    ...
    private void alreadyScore() {
        SPUtil.set(KEY_SCORE_FLAG, true);
    }
...
//        centerDialog.show();
        if (null == centerDialog) {
            centerDialog = new DialogBuilder(activity)
                    ...
                    .setCancelBtnStyle("稍后再说", com.lalifa.base.R.color.basis_color_secondary, -1, new View.OnClickListener() {
                        @Override
    ...
    private void shwoDownDialog() {
        ...
        builder.setTitle("请问哪个方面需要改进呢")
                ...
                .setCancelBtnStyle("提交反馈", com.lalifa.base.R.color.basis_color_secondary, -1, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                ...
                .setSureBtnStyle("我再想想", com.lalifa.base.R.color.basis_color_secondary, -1, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dismissDialog();
                    }
...
//                }, centerDialog.getLayoutInflater().inflate(R.layout.layout_promotion, null));
        IBuilder builder = centerDialog.getBuilder();
        builder.setTitle("随心语音最近活动，了解一下？")
                .setEnableTitle(true)
                .setCustomerView(initDownView())
                .setCancelBtnStyle("我想了解", com.lalifa.base.R.color.basis_color_secondary, -1, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        jumpPromotionPage();
                    }
                })
                .setSureBtnStyle("我再想想", com.lalifa.base.R.color.basis_color_primary, -1, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        dismissDialog();
                    }
