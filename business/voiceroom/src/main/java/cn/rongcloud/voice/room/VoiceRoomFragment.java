...
//        mRoomMessageAdapter.setMessages(list, isRefresh);
    ...
    @Override
    public void showVideoGift() {
        VideoGiftFragment f = new VideoGiftFragment(getContext());
        f.show();
    }
    ...
    public void setRoomData(VoiceRoomBean voiceRoomBean) {
        ...
        // 加载背景
        ImageLoader.loadUrl(mBackgroundImageView, voiceRoomBean.getBackgroundUrl(), com.lalifa.base.R.color.black);
        // 设置title数据
