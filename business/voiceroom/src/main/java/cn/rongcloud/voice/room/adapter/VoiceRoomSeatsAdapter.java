    ...
    public void onBindViewHolder(@NonNull SeatItemViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        switch (uiSeatModel.getSeatStatus()) {
            case RCSeatStatusUsing:
                ...
                holder.iv_user_portrait.setBackgroundResource(cn.rongcloud.roomkit.R.drawable.bg_voice_room_portrait);
            ...
            case RCSeatStatusEmpty:
                ...
                holder.iv_is_mute.setVisibility(uiSeatModel.isMute() ? View.VISIBLE : View.GONE);
                holder.tv_member_name.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                holder.iv_seat_status.setImageDrawable(context.getDrawable(cn.rongcloud.roomkit.R.drawable.ic_seat_status_enter));
                holder.tv_member_name.setText((position + 1) + " 号麦位");
                holder.iv_user_portrait.setImageDrawable(context.getDrawable(cn.rongcloud.roomkit.R.drawable.bg_seat_status));
            ...
            case RCSeatStatusLocking:
                ...
                holder.iv_is_mute.setVisibility(uiSeatModel.isMute() ? View.VISIBLE : View.GONE);
                holder.tv_member_name.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                holder.iv_seat_status.setImageDrawable(context.getDrawable(cn.rongcloud.roomkit.R.drawable.ic_seat_status_locked));
                holder.tv_member_name.setText((position + 1) + " 号麦位");
                holder.iv_user_portrait.setImageDrawable(context.getDrawable(cn.rongcloud.roomkit.R.drawable.bg_seat_status));
                holder.iv_user_portrait.setBackground(null);
                break;
