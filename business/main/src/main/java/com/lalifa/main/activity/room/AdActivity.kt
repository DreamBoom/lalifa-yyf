...
import com.lalifa.main.databinding.ActivityAdBinding
import com.zzhoujay.richtext.RichText

class AdActivity : BaseTitleActivity<ActivityAdBinding>() {
    override fun getViewBinding()= ActivityAdBinding.inflate(layoutInflater)
    override fun title()="详情"
    override fun initView() {
        val ad = getIntentString("ad")
// 设置为Html
        RichText.fromHtml(ad).into(binding.tv)
// 设置为Markdown
      //  RichText.fromMarkdown(ad).into(binding.tv)
    }
