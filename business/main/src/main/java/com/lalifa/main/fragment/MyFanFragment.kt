...
import com.lalifa.main.databinding.FragmentFanBinding
import com.lalifa.main.databinding.ItemFanBinding

class MyFanFragment : BaseFragment<FragmentFanBinding>() {
    override fun getViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentFanBinding.inflate(layoutInflater)

    override fun initView() {
        scopeNetLife {
            val friends = friends(1)
            binding.apply {
                list.linear().setup {
