...
import com.lalifa.main.activity.room.adapter.interfaces.DataObserver;
import com.lalifa.main.activity.room.adapter.interfaces.IAdapte;
import com.lalifa.main.activity.room.adapter.interfaces.IHolder;
 ...
 * @param <T>
 */
public abstract class RcyAdapter<T, VH extends IHolder> extends
        RecyclerView.Adapter<RecyclerView.ViewHolder> implements IAdapte<T, VH> {
